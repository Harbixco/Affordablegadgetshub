...
import { powerbankproducts } from "../../DummyData/data";
...
export default function Powerbank() {
  ...
  return (
    <>
      <div
        id="powerbank"
        className="flex scroll-mt-24 items-center justify-between bg-[#E61601] px-4 py-2 text-[#FEFAFA] md:px-6"
      >
        ...
        <button
          onClick={() => navigate("/all-power-banks")}
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-5">
        {powerbankproducts.slice(0, itemsToShow).map((item) => (
          <div
            key={item.id}
