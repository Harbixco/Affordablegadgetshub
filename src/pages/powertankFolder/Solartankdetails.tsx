...
export default function Solartankdetails() {
  ...
  const product = solartankproducts.find((item) => item.id.toString() === id);
      ...
      <div className="mx-auto max-w-6xl p-4 md:p-8">
        ...
        <div className="grid gap-8 rounded-lg bg-white p-4 shadow md:grid-cols-2">
          ...
          <div className="flex flex-col justify-between">
            ...
            {/* ✅ BUTTONS (same as powerbank, works on mobile) */}
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {relatedProducts.map((item) => (
                <Link
                  to={`/solarproductdetails/${item.id}`}
                  key={item.id}
